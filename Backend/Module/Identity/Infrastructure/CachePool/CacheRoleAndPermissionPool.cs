...
namespace Identity.Infrastructure.CachePool
{
    public static class CacheRoleAndPermissionPool
    {
        ...
        public static void SetRoleList(HashSet<RoleModel> roleList) => RoleList = roleList;
        public static void SetPermissionList(HashSet<PermissionModel> permissionList) => PermissionList = permissionList;
